var UNIT_WINDOW_MANAGER_OFFSET_X = -150;
...
var SelectorEventUnitWindowManager = defineObject(BaseWindowManager, {
    ...
    getPositionWindowX: function() {
        ...
        var offsetX = UNIT_WINDOW_MANAGER_OFFSET_X

        if (this._unit == null) {
            return LayoutControl.getCenterX(-1, width) + offsetX;
        }

		return LayoutControl.getUnitBaseX(this._unit, width) + offsetX;
	},
