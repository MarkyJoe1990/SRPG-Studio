...
How do I use it?
- take the Weather-Effects folder and put it in your plugins folder
- take the weather-material folder and put it in your material folder
	- If you don't have a material folder in the root of your SRPG Studio project, make one
	- Then put weather-material folder in it
...
- You can view the names of weathers by looking at the js files within the WeatherObject folder
...
- Your new weather object should overwrite certain functions from the base WeatherObject. refer to weather-base-object.js for more information
